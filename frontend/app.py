...
with st.sidebar:
    ...
    st.markdown( textwrap.dedent("### 🧭 Navigation"))
...
if page == "Document Extraction":
        ...
        textwrap.dedent(
            ...
            <div class="hero">
                ...
                <div class="hero-description">
                    Upload a legal property document and let our
                    document intelligence pipeline extract the
                    important information automatically using
                    OCR and a local language model.
                </div>
    ...
    if uploaded_file:
        ...
        if st.button(
            ...
            with st.spinner(
                "Analyzing document with DocTR and AI..."
            ):
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="hero">
            ...
            <div class="hero-description">
                An AI-powered document information extraction
                system designed to automatically identify
                important information from legal property reports.
            </div>
    ...
    with col1:
        ...
        st.markdown(
            ...
            Optical Character Recognition extracts
    ...
    with col2:
        ...
        st.markdown(
            ...
            A local language model identifies the
            predefined fields from the extracted text.
            """
        )
    ...
    with col3:
        ...
        st.markdown(
            ...
            The backend coordinates document
            processing and returns structured data.
            """
        )
